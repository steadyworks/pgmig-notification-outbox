...
--
-- Name: idx_share_channels_scheduled_for; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_share_channels_scheduled_for ON public.share_channels USING btree (scheduled_for);
...
--
-- Name: idx_share_channels_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_share_channels_status ON public.share_channels USING btree (status);
